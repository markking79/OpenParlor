...
import { router as openParlorMemoryRouter } from './openparlor/memory-router.js';
import { router as openParlorSettingsRouter } from './openparlor/settings-router.js';
...
export function setupPrivateEndpoints(app) {
    ...
    app.use('/api/openparlor/memories', openParlorMemoryRouter);
    app.use('/api/openparlor/settings', openParlorSettingsRouter);
}
